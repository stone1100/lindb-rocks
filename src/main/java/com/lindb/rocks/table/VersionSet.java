...
public class VersionSet implements SeekingIterable<InternalKey, byte[]> {
    ...
    public void recover() throws IOException {
        ...
        try (FileChannel fileChannel = new FileInputStream(new File(databaseDir, currentName)).getChannel()) {
            ...
            Reader reader = new Reader(fileChannel, Monitors.throwExceptionMonitor(), true, 0);
    ...
    public Compaction pickCompaction() {
        ...
        if (sizeCompaction) {
            ...
            Preconditions.checkState(level + 1 < DBConstants.NUM_LEVELS);
